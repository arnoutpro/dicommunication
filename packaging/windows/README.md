...
2. Start **Dicommunication**, **Dicomtag Analytics**, or **Dicom Anonymizer** from the Start menu (or the Desktop, if that shortcut was selected) — arnout.pro brand mark icon, same as the watermark.
