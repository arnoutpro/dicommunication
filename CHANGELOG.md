...
- **Vue PACS Database Analytics** Query: DICOM keys are a compact tree (checkboxes kept); results sit on the right of the filters so tables can use the remaining width.
