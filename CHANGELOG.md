...
- **Vue PACS Database Analytics**: **List SR reports** after a Study query (Series C-FIND, modality SR, same Study Instance UID). **Retrieve report text** C-MOVEs those series to this AE when Accept C-STORE is on, then flattens the DICOM Content Sequence. No language model.
